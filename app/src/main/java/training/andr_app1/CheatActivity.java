...
public class CheatActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_ANSWER_IS_TRUE = "training.andr_app1.answer_is_true";
    public static final String EXTRA_ANSWER_SHOWN = "training.andr_app1.answer_shown";
